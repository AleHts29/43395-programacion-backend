...
crouton_thrift.SpanRecord.prototype.read = function (input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      case 11:
        if (ftype == Thrift.Type.STRING) {
          this.trace_guid = input.readString();
        } else {
          input.skip(ftype);
        }
        break;
      ...
      case 1:
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i53 = 0; _i53 < _size48; ++_i53) {
            var elem54 = null;
            elem54 = new ttypes.MetricsSample();
            elem54.read(input);
      ...
      case 2:
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i60 = 0; _i60 < _size55; ++_i60) {
            var elem61 = null;
            elem61 = new ttypes.MetricsSample();
            elem61.read(input);
      ...
      case 9:
        if (ftype == Thrift.Type.LIST) {
          ...
          for (var _i83 = 0; _i83 < _size78; ++_i83) {
            var elem84 = null;
            elem84 = new ttypes.NamedCounter();
            elem84.read(input);
...
//# sourceMappingURL=crouton_types.js.map