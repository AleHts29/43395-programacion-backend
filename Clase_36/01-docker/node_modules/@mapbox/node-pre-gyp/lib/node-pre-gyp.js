...
exports.mockS3Http = require('@mapbox/node-pre-gyp/lib/util/s3_setup').get_mockS3Http();
...
log.disableProgress();
const napi = require('@mapbox/node-pre-gyp/lib/util/napi');
...
Object.defineProperty(exports, 'find', {
  get: function () {
    return require('@mapbox/node-pre-gyp/lib/pre-binding').find;
  },
  enumerable: true
});
...
proto.package = require('@mapbox/node-pre-gyp/package.json');
